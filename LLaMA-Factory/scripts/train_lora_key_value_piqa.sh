...
accelerate launch \
    ...
    --optim adamw_torch \
    --packing False \
    --output_dir saves/LLaMA-7B/lora/piqa/train_piqa_init_5e-5_16 \
    --bf16 True \
    --plot_loss True \
    ...
    --resume_from_checkpoint /liymai24/sjtu/bokai/LLaMA-Factory/saves/LLaMA-7B/lora/piqa_baseline/train_piqa_init_5e-5 \
    # ,mean_key,mean_value
...
accelerate launch \
    ...
    --flash_attn auto \
    --dataset_dir data \
    --dataset obqa_train,obqa_train2 \
    --cutoff_len 1024 \
    --learning_rate 2e-04 \
    ...
    --optim adamw_torch \
    --packing False \
    --output_dir saves/LLaMA-7B/lora/obqa/train_lora_key_value_mean_2e-04_64_64_ep4 \
    --bf16 True \
    --plot_loss True \
    ...
    --resume_from_checkpoint /liymai24/sjtu/bokai/LLaMA-Factory/saves/LLaMA-7B/lora/obqa_baseline/train_lora_key_value_mean_128_128_2e-04 \
    # ,mean_key,mean_value
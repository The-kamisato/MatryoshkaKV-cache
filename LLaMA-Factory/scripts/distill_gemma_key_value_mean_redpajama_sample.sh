...
accelerate launch \
    ...
    --stage pt \
    --do_train True \
    --model_name_or_path /liymai24/sjtu/bokai/PCA_kvcache/checkpoint/gemma-2b \
    ...
    --optim adamw_torch \
    --packing False \
    --output_dir saves/LLaMA-7B/distillation/redpajama/train_only_proj_16_64_64_gemma3 \
    --bf16 True \
    --plot_loss True \

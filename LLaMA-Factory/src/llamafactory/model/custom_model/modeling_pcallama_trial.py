...
class PcaLlamaForCausalLM(LlamaForCausalLM):
    ...
    def forward(
        ...
        position_ids: Optional[torch.LongTensor] = None,
        past_key_values: Optional[Union[Cache, List[torch.FloatTensor]]] = None,
        key_truncate_index: Union[int, List[int], torch.LongTensor] = torch.full((32, 32), 128, dtype=torch.long),      # change this
        value_truncate_index: Union[int, List[int], torch.LongTensor] = torch.full((32, 32), 128, dtype=torch.long),
        inputs_embeds: Optional[torch.FloatTensor] = None,

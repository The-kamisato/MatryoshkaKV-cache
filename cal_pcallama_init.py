...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default='meta-llama/Llama-2-7b', help="model path")
    parser.add_argument("--data_path", type=str, default='LLaMA-Factory/data/alpaca_data_en_52k.json', help="data path")
    ...
    for i in tqdm(len(alpaca_dataset) // 5, desc="Inferencing"):
        past_key_values_list = []
        for index in range(i * 5, (i + 1) * 5):
            # context, question = dataset[index]
            # prompt = context + question
            prompt = alpaca_dataset[index]['input']
